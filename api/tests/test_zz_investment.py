...
class InvestmentApiTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        with patch("main.load_config", return_value=MOCK_CONFIG):
            cls.app = create_app(orchestrator_client_factory=lambda **kwargs: cls.upstream)
    ...
    def test_dashboard_proxies_shared_orchestrator_client(self):
        ...
        self.assertEqual(args[:2], ("GET", "http://orchestrator:8000/investment/dashboard"))
    ...
    def test_analysis_forwards_market_inputs_and_returns_published_result(self):
        ...
        self.assertEqual(
            self.upstream.request.await_args.kwargs["json"]["market_inputs"]["discount_rate"],
            10,
        )
    ...
    def test_investment_page_renders_required_sections(self):
        ...
        self.assertIn("Deterministic signal ledger", response.text)
