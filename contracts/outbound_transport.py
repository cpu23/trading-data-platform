...
class PublicOnlyHTTPTransport(httpx.HTTPTransport):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self._child_transports: dict[tuple[str, str, int], httpx.HTTPTransport] = {}
        self._children_lock = threading.Lock()

    def _child_transport(self, origin_key: tuple[str, str, int]) -> httpx.HTTPTransport:
        with self._children_lock:
            ...
            if child is None:
                ...
                if len(self._child_transports) >= self._MAX_CHILD_TRANSPORTS:
                    oldest_key, oldest = next(iter(self._child_transports.items()))
