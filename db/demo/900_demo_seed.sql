...
INSERT INTO cycle_runs (correlation_id, status, started_at, completed_at, triggered_by, run_kind, result_status, summary) VALUES
('77777777-7777-4777-8777-777777777777', 'completed', NOW() - INTERVAL '35 minutes', NOW() - INTERVAL '30 minutes', 'demo', 'cycle', 'success', '{"fixture":true}');
